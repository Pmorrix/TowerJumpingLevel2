...
public class BuildingGoalController : MonoBehaviour
{
    [Header("Refs")]
    ...
    private void RegisterPlayerEnter(Collider other)
    {
        ...
        if (_goalEnabled && phaseManager != null)
            phaseManager.OnPlayerTouchedGoal(GetGoalTopCenter());
    }
    ...
    private void RegisterPlayerExit(Collider other)
    {
        ...
        if (!IsPlayerOnGoal && phaseManager != null)
            phaseManager.OnPlayerExitedGoalArea();
    }
